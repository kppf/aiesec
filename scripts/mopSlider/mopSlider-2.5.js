...
jQuery.fn.extend({
	mopSlider:function(stt){
		...
		var mopSldSrc=function(mopSldTyp){
			if(mopSldTyp=="paper"){
				btnLeft.src="scripts/mopSlider/paper/sliderBtnLtW.png";
				btnLeftF.src="scripts/mopSlider/paper/sliderBtnLtW_f.png";
				btnRight.src="scripts/mopSlider/paper/sliderBtnRtW.png";
				btnRightF.src="scripts/mopSlider/paper/sliderBtnRtW_f.png";
				btnCenter.src="scripts/mopSlider/paper/sliderBtnW.png";
				btnChange.src="scripts/mopSlider/paper/sliderBkRtRtW.png";
				btnChangeNn.src="scripts/mopSlider/paper/sliderBkRtRtNnW.png";
				btnChangeF.src="scripts/mopSlider/paper/sliderBkRtRtW_f.png";
				bkImg.src="scripts/mopSlider/paper/paperBk.gif";
				sldcLeftImg.src="scripts/mopSlider/paper/sliderBkLtLtW.png";
				sldBkLeft.src="scripts/mopSlider/paper/sliderBkLtW.png";
				sldBkCenter.src="scripts/mopSlider/paper/sliderBkW.png";
				sldBkRight.src="scripts/mopSlider/paper/sliderBkRtW.png";
			}
			
			else if(mopSldTyp=="black"){
				btnLeft.src="scripts/mopSlider/black/sliderBtnLt.png";
				btnLeftF.src="scripts/mopSlider/black/sliderBtnLt_f.png";
				btnRight.src="scripts/mopSlider/black/sliderBtnRt.png";
				btnRightF.src="scripts/mopSlider/black/sliderBtnRt_f.png";
				btnCenter.src="scripts/mopSlider/black/sliderBtn.png";
				btnChange.src="scripts/mopSlider/black/sliderBkRtRt.png";
				btnChangeNn.src="scripts/mopSlider/black/sliderBkRtRtNn.png";
				btnChangeF.src="scripts/mopSlider/black/sliderBkRtRt_f.png";
				bkImg.src="scripts/mopSlider/black/monoBk.gif";
				sldcLeftImg.src="scripts/mopSlider/black/sliderBkLtLt.png";
				sldBkLeft.src="scripts/mopSlider/black/sliderBkLt.png";
				sldBkCenter.src="scripts/mopSlider/black/sliderBk.png";
				sldBkRight.src="scripts/mopSlider/black/sliderBkRt.png";
			}

			else if(mopSldTyp=="ostemplates"){
				btnLeft.src="scripts/mopSlider/ostemplates/sliderBtnLtW.png";
				btnLeftF.src="scripts/mopSlider/ostemplates/sliderBtnLtW_f.png";
				btnRight.src="scripts/mopSlider/ostemplates/sliderBtnRtW.png";
				btnRightF.src="scripts/mopSlider/ostemplates/sliderBtnRtW_f.png";
				btnCenter.src="scripts/mopSlider/ostemplates/sliderBtnW.png";
				btnChange.src="scripts/mopSlider/ostemplates/sliderBkRtRtW.png";
				btnChangeNn.src="scripts/mopSlider/ostemplates/sliderBkRtRtNnW.png";
				btnChangeF.src="scripts/mopSlider/ostemplates/sliderBkRtRtW_f.png";
				bkImg.src="scripts/mopSlider/ostemplates/ostemplatesBk.gif";
				sldcLeftImg.src="scripts/mopSlider/ostemplates/sliderBkLtLtW.png";
				sldBkLeft.src="scripts/mopSlider/ostemplates/sliderBkLtW.png";
				sldBkCenter.src="scripts/mopSlider/ostemplates/sliderBkW.png";
				sldBkRight.src="scripts/mopSlider/ostemplates/sliderBkRtW.png";
			}
		...
		'<div class="sliderCase">'+
			...
			'</div>'+
		'</div>'
		// Comment out rounded corners s dont need them
		...
		$(mpSldNm+" .indi").css({paddingTop:"5px",fontSize: "10px",textAlign:"center",letterSpacing:"0.05em"});
		...
		$(mpSldNm+" .leftTopIn").css({height:"10px",width:"10px",backgroundImage:"url(scripts/mopSlider/box-corners/sliderCrnLtTp.png)",backgroundRepeat:"no-repeat"});
		$(mpSldNm+" .rightTop").css({height:"10px",width:"10px",position:"absolute",top:"0px",right:"0px"});
		$(mpSldNm+" .rightTopIn").css({height:"10px",width:"10px",backgroundImage:"url(scripts/mopSlider/box-corners/sliderCrnRtTp.png)",backgroundRepeat:"no-repeat"});
		$(mpSldNm+" .leftBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",left:"0px"});
		$(mpSldNm+" .leftBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(scripts/mopSlider/box-corners/sliderCrnLtBtm.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
		$(mpSldNm+" .rightBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",right:"0px"});
		$(mpSldNm+" .rightBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(scripts/mopSlider/box-corners/sliderCrnRtBtm.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
		...
		// $(mpSldNm+" .holder").children().children().css({marginRight:itemMgn+"px",float:"left",position:"relative"});
		$(mpSldNm+" .holder").children().children().css({});
		...
		mpSldF={
			...
			auto:function(mpSldNo,mpSldNm,mopSldTyp){
				mopSldSrc(mopSldTyp);
				$(mpSldNm+" .indi").html("Slide For More");
				var j=mpSldNo-1;
				if(autoS[j]!="yn"){
					if(browser!="ie6"){
