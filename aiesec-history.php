<?php
	...
	show_header('History | AIESEC', 'aiesechistory');
?>
...
<br /><br /> 
*<strong> Note:</strong> <em>Nowadays, the french acronym AIESEC is no longer used by the organization, since in the history AIESEC expanded to other backgrounds different to Economic and Commercial Sciences. Please use AIESEC simply as is.</em> </p>                
				<br /><br /> 
                <p> 
...
It was a movement of expansion from the ‘traditional' traineeship exchange programmes and gave more meaningful experiences to the exchange participant. SSTPs engaged a limited amount of selected trainees, each undergoing unique training and education but in a common field or topic on a project. Every week they took time off from their firms to meet for lectures and group discussions and at the end of their traineeship period, joint and individual reports were produced. By the end of 1969, 22 SSTPs were successfully carried out in eleven different countries.
				...
				<br /><br /> 
                <p>In 1967, work began on a program dubbed Student Traineeship Exchange System (STRES) for an effective and fair approach to facilitate flow and standardization of information. Exchange numbers have already reached the 4500 mark and matching that large group of students to the diverse array of traineeships was stretching the capacity of AIESEC.
<br /><br /> 
